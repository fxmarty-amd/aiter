...
def get_x_vals():
    ...
    # Qwen3-32B
    # x_vals += [(v, 10240, 5120) for v in [1, 2, 4, 8, 16]]   # qkv_proj
    # x_vals += [(v, 5120, 8192) for v in [1, 2, 4, 8, 16]]     # o_proj
    # x_vals += [(v, 51200, 5120) for v in [1, 2, 4, 8, 16]]    # gate_up_proj
    x_vals += [(v, 5120, 25600) for v in [1, 2, 4, 8, 16]]    # down_proj
